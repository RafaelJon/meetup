...
var sources = []*ast.Source{
	&ast.Source{Name: "graph/meetup-schema.graphqls", Input: `type User{
    id: ID!
    username: String!
    email: String!
...
func (ec *executionContext) _Meetup_user(ctx context.Context, field graphql.CollectedField, obj *models.Meetup) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_meetups(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMeetup2ᚕᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐMeetupᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2githubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v models.Meetup) graphql.Marshaler {
	return ec._Meetup(ctx, sel, &v)
}

func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *models.Meetup) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v models.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋRafaelJonᚋmeetupᚋgraphᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
